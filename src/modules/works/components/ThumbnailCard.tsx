...
export const ThumbnailCard: VFC<Props> = ({ work }) => {
  ...
  return (
    <Link href={`/works/${id}`}>
      <a className="block group rounded-lg overflow-hidden outline-none focus-visible:ring-main focus-visible:ring-2 focus-visible:ring-opacity-80">
        <figure className="relative aspect-w-16 aspect-h-9 bg-grayDark border border-white border-opacity-10">
